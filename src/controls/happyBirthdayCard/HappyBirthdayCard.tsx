...
const imageTemplate: { imageUrl: string }[] = [
  {
    imageUrl: require("../../webparts/birthday/assets/cof.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof5.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof1.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof3.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof8.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/baloons.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof2.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof10.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof11.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof12.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof14.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof14_1.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof18.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof17.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof19.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof20.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof22.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof24.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof28.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof29.png"),
  },
  {
    imageUrl: require("../../webparts/birthday/assets/cof30.png"),
  },
];

export class HappyBirthdayCard extends React.Component<
  IHappyBirthdayCardProps,
  IHappyBirthdayCardPState
> {
  ...
  public render(): React.ReactElement<IHappyBirthdayCardProps> {
    this._birthdayMsg = this.state.isBirthdayToday
      ? this.props.anniversary
        ? strings.HappyAnniversaryMsg
        : strings.HappyBirthdayMsg
      : this.props.anniversary
      ? strings.NextAnniversaryMsg
      : strings.NextBirthdayMsg;
    return (
        ...
        <div className={styles.documentCardWrapper}>
          <div className={styles.documentCard}>
            ...
            {this.state.isBirthdayToday ? (
              <Label className={styles.displayBirthdayToday}>
                {this.props.birthday}
              </Label>
            ) : (
              <Label className={styles.displayBirthday}>
                {this.props.birthday}
              </Label>
            )}
  ...
  private _birthdayIsToday(birthday: string): boolean {
    ...
    const _retvalue =
      _todayDay === _birthdayDay && _todayMonth === _birthdayMonth
        ? true
        : false;
  ...
  private _getInitial(userName: string): string {
    ...
    const _initial =
      _arr[0].charAt(0).toUpperCase() +
      (_arr[1] ? _arr[1].charAt(0).toLocaleUpperCase() : "");
    return _initial;
  }
